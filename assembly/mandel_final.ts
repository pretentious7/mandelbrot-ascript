...
//(-0.761574,-0.0847596
//-1.62917,-0.0203968
const START_X_TOTAL:f32 = -0.101
const START_Y_TOTAL:f32 =  0.956
const WINDOW:f32 = 0.001
...
const start_y = START_Y_TOTAL;
const start_x:f32 = START_X_TOTAL + f32(start_xc) * step_X
const end_xc:i32 = start_xc + segment
let a1 = f32x4(0,0,0,0);
let a2 = f32x4(0,0,0,0);
let memcounter = start_xc * canvas_height * 4;
